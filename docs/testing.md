...
| `src/routes/_authenticated/orgs/$orgName/settings/-system-templates.test.tsx` | Platform templates list and detail: names, descriptions, mandatory badge, RBAC (owner/viewer), skeleton, error state |
